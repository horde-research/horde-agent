...
_STAGE_ARTIFACT_KEYS: dict[str, set[str]] = {
    ...
    ActionType.ASSESS_SOURCE_QUALITY.value: {
        "data_path",
        "source_quality_enabled",
        "source_quality_input_data_path",
        "source_quality_filtered_data_path",
        "source_quality_profile_path",
        "source_quality_clusters_path",
        "source_quality_oracle_payload_path",
        "source_quality_policy_path",
        "source_quality_report_path",
        "source_quality_decisions_path",
        "source_quality_accepted_sources_path",
        "source_quality_summary",
        "source_quality_oracle",
        "source_quality_query_refinements",
    },
    ActionType.BUILD_SFT_DATASET.value: {
        ...
        "annotation_reuse_summary",
        "sft_answerability_summary",
        "sft_answerability_report_path",
        "heldout_eval_annotation_reuse_summary",
        "heldout_eval_answerability_summary",
        "heldout_eval_answerability_report_path",
        "source_split_summary",
        "heldout_eval_source_path",
        "heldout_eval_sft_path",
        "heldout_eval_annotations_path",
        "heldout_eval_num_examples",
        "heldout_eval_generation_error",
    },
    ...
    ActionType.EVALUATE_MODEL.value: {
        ...
        "base_failures_path",
        "base_judge_summary",
        "base_eval_metrics_path",
        "eval_lift_summary",
        "eval_lift_summary_path",
        "source_challenge_eval_dir",
        "source_challenge_data_path",
        "source_challenge_split",
        "source_challenge_predictions_path",
        "source_challenge_failures_path",
        "source_challenge_cluster_preview",
        "source_challenge_eval_metrics_path",
        "source_challenge_eval_metrics",
        "source_challenge_training_health",
        "source_challenge_judge_summary",
        "source_challenge_base_predictions_path",
        "source_challenge_base_failures_path",
        "source_challenge_base_judge_summary",
        "source_challenge_base_eval_metrics_path",
        "source_challenge_lift_summary",
        "source_challenge_lift_summary_path",
        "source_challenge_eval_error",
        "adapter_repo_id",
